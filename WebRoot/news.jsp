    ...
    <TD vAlign=top align=left width=760 height=547>
      <TABLE class=border2 height=250 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          <IMG height=11 src="<%=basePath%>images/up.gif" width=11></SPAN><STRONG> 股市动态 </STRONG></TD></TR>
<%		
        ...
        <TR>
          <TD>
            <TABLE height=38 background=<%=basePath%>images/xx.htm border=0>
              <TBODY>
              <TR bgColor=#eeeeee>
                <TD align=left width=661 height=20><A href="<%=basePath %>newsinfo.jsp?id=<%=pagelist2.get(0).toString()%>"><%=pagelist2.get(1).toString()%></A></TD>
                <TD align=right width=109><%=pagelist2.get(3).toString().substring(0,10) %></TD>
              </TR>
              </TBODY>
            </TABLE>
          </TD>
            ...
            align=center border=0>
              ...
              <TR>
                ...
                height=25><STRONG><SPAN 
                  class=font_02>热门商品</SPAN></STRONG></TD>
