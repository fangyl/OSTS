...
%> 
    <TR class="css_col11">
      ...
      <TD>
      <a href="<%=basePath%>useMember.action?method=ifusem&id=<%=pagelist2.get(0).toString()%>" ><%=pagelist2.get(9).toString() %></a></td>
      <TD>
      <a href="<%=basePath%>delMember.action?method=delm&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
<% }} %> 
  <TR class="css_col11"> 
				<TD colspan=10>
