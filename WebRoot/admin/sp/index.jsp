...
<table width=100% border=0 cellpadding=3 cellspacing=1 class=css_table bgcolor='#E1E1E1'>
  ...
  <TR class="css_col11">
    <tr align=center>
      ...
      <td><strong>股票分类</strong></td>
      <td><strong>股票价格</strong></td>
...
%> 
    <TR class="css_col11">
      ...
      <td><a href="<%=basePath%>admin/sp/add.jsp?method=uphh&id=<%=pagelist2.get(0).toString()%>" >修改</a></td>
      <td><a href="<%=basePath%>delSp.action?method=delhh&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
<% }} %> 
  <TR class="css_col11"> 
				<TD colspan=10>
