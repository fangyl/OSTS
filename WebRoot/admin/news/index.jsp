...
%> 
    <TR class="css_col11">
      ...
      <td><%=pagelist2.get(3).toString() %></td> 
       <td><a href="<%=basePath%>admin/news/add.jsp?method=upnews&id=<%=pagelist2.get(0).toString()%>" >修改</a></td>
      <td><a href="<%=basePath%>delNews.action?id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
<% }} %> 
  <TR class="css_col11"> 
				<TD colspan=10>
