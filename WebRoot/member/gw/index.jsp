...
function top2(){
   	form3.action="<%=basePath%>member/gw/index.jsp?page=1";
    form3.submit();
}
function last2(){
	...
	form3.action="<%=basePath%>member/gw/index.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre2(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%>member/gw/index.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump2(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%>member/gw/index.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%>member/gw/index.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%>member/gw/index.jsp?page="+page;
      form3.submit();
...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    <tr>
      <th class="bg_tr" align="left" colspan="11" height="25">订单信息管理 </th>
    </tr>
    <tr align=center>
      <td class="td_bg" height="23"><strong>序号</strong></td>
      <td class="td_bg"><strong>订单编号</strong></td> 
      <td class="td_bg"><strong>购买用户</strong></td>
      <td class="td_bg"><strong>购买时间</strong></td> 
      <td class="td_bg"><strong>状态</strong></td>  
      <td class="td_bg"><strong>订单详细</strong></td>  
    </tr>
<%	 
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where member='"+member+"' order by id desc",6);
...
%> 
    <tr align=center>
      ...
      <td class="td_bg"><a href="<%=basePath %>ddinfo.jsp?ddbh=<%=pagelist2.get(1).toString()%>" target="_blank">订单详细</a></td>
    </tr>
<% }} %> 
  </tbody>
</table>
